        ...
        for symbol in symbols:
            try:
                ...
                for i, (strategy_name, result) in enumerate(results):
                    ...
                    trades_item.setText(str(total_trades))
                    trades_item.setData(Qt.ItemDataRole.DisplayRole, total_trades)
                    print(f"Total Trades Type: {type(total_trades)}, Value: {total_trades}")
