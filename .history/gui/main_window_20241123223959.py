...
class MainWindow(QMainWindow):
    ...
    def generate_detailed_report(self, aggregated_results):
        ...
        for strategy_name, results in aggregated_results.items():
            strategy_instance = next((s for s in self.strategies if s.__name__ == strategy_name), None)
            ...
            strategy_report["Risk Management Framework"] = {
                "Position Sizing Method": str(strategy.position_sizing_method),
                "Position Size Value": strategy.position_size_value,
