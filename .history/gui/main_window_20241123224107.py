                ...
                for strategy_class in selected_strategies:
                    ...
                    if strategy_class.__name__ not in aggregated_results:
                        aggregated_results[strategy_class.__name__] = {
                            ...
                            'profit_factor': 0,
                            'symbols': [],
                            'strategy_instances': []  # Add this to store instances
                        }
                    ...
                    agg['strategy_instances'].append(strategy)  # Store the strategy instance
    ...
    def generate_detailed_report(self, aggregated_results):
        ...
        for strategy_name, results in aggregated_results.items():
            ...
            strategy_report = {
                ...
                "Performance Metrics": {
                    ...
                    "Drawdown Metrics": {
                        ...
                        "Average Drawdown %": results.get('avg_drawdown', None),
                        # ... other drawdown metrics ...
                    },
                ...
                "Risk Analysis": {
                    ...
                    # ... other risk analysis data ...
                },
                # ... other sections as per your ideas ...
            }
            ...
            strategy_report["Trade Statistics"] = {
                ...
                "Average Trade Duration": results.get('avg_trade_duration'),
                # ... other trade stats ...
            }
            ...
            if strategy_instance:
                strategy_report["Risk Management Framework"] = {
                    "Position Sizing Method": str(strategy_instance.position_sizing_method),
                    "Position Size Value": strategy_instance.position_size_value,
            ...
            strategy_report["Backtest Analysis"] = {
                "Data Quality": "Describe data quality",
                "Backtest Settings": {
                    "Lookback Period": "Specify lookback period",
                    "Data Frequency": "Specify data frequency",
                    # ... other settings ...
                },
                "Overfitting Risks": "Describe overfitting risks",
                # ... other backtest analysis ...
            }
